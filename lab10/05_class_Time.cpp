...
public:
    ...
    {
        stringstream ss;
        ss << setfill('0') << setw(2) << this->getDuration() / 3600 << ":" << setfill('0') << setw(2) << (this->getDuration() % 3600) / 60 << ":" << setfill('0') << setw(2) << this->getDuration() % 60;
        return ss.str();
    }
};
...
int main()
{
    ...
    cout << t1.add(Time(1, 1, 1)).getHour() << endl;
